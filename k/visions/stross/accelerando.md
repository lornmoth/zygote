 ...
 * * *
 ...
 Calcutta: a kind of Serdar Argic^[Alias of a Usenet bot responsible for one of the first automated newsgroup spam incidents. Serdar Argic (address: sera@zuma.uucp) appeared to be programmed to run a daily search on all of Usenet for "Turkey" or "Armenia," and replied to any hit with canned screeds of a Turkish nationalist nature, often focusing on Armenian genocide denialism.] of intellectual property, or maybe
 ...
 * * *
 ...
 She fixes him with a riding-crop^[A riding crop is a short, lashless whip designed for use in horse-riding, but popular in sado-masochistic fetishm. It's traditionally associated with [(dominatrices)](https://www.bonhams.com/auctions/16875/lot/165/).] stare: "Don't flatter yourself. There
 ...
 * * *
 ...
 Turing-completeness as an attribute of company law^[Turing-completeness is the property of a system being able to, under some simple representation of input & output, compute any program; in essence, a fully functioning computer. <br/><br/> In this case, company law presumably refers to smart contracts which, sufficiently defined, could reasonably be Turing-complete.], about cellular
 automata^[Simulation collection of cells on a grid of specified shape that evolves through a number of discrete time steps according to a set of rules based on the states of neighboring cells. The rules are then applied iteratively for as many time steps as desired. The complex class of automata is considered computationally universal, or capable of simulating a Turing machine.] and the blind knapsack problem^[The knapsack problem is a problem in combinatorial optimization: Given a set of items, each with a weight and a value, determine the number of each item to include in a collection so that the total weight is less than or equal to a given limit and the total value is as large as possible. It derives its name from the problem faced by someone who is constrained by a fixed-size knapsack and must fill it with the most valuable items. 
<br/><br/>
 The knapsack problem is interesting from the perspective of computer science for a multitude of reasons:
 <br/><br/>
...
<br/><br/>
 * Many cases that arise in practice, and "random instances" from some distributions, can nonetheless be solved exactly.], about his work on solving the
 ...
 * * *
 ...
 Objectivism^[Outsider philosophical system developed by Russian-American writer Ayn Rand in her novels *The Fountainhead* and *Ayn Rand*, summarized as the concept of man as a heroic being, with his own happiness as the moral purpose of his life, with productive achievement as his noblest activity, and reason as his only absolute.<br/><br/>Presumably the Mafiya consider piracy to undermine the noble goal of productive achievement.]. Reputations only of use to those alive to own them.
 Goodbye."
 ...
 * * *
 ...
 reputation market has gone nonlinear^[In thermal dynamics, a nonlinear dynamical system changes in variables over time, appearing chaotic, unpredictable, or counterintuitive in comparison to much simpler linear systems.]: People are putting their trust
 ...
 bastard child of George Soros^[Notorious investment banker and the largest public funders of European progressive initiatives. Central figure in many European right-wing conspiracy theories.] and Richard Stallman^[Pioneer of the Free Software movement and founder of the Free Software Foundation, promoting the right to free information and to software modification.]. His reputation is
 ...
 Lebanese youngsters, point the yellow snout of their mass spectroscope^[Mass spectrometry (MS) is an analytical technique that ionizes chemical species and sorts the ions based on their mass-to-charge ratio. In simpler terms, a mass spectrum measures the masses within a sample. In a typical MS procedure, a sample, which may be solid, liquid, or gas, is ionized, for example by bombarding it with electrons, causing some of the sample's molecules to break into charged fragments. These ions are then separated according to their mass-to-charge ratio, typically by accelerating them and subjecting them to an electric or magnetic field: ions of the same mass-to-charge ratio will undergo the same amount of deflection. The ions are detected by a mechanism capable of detecting charged particles, such as an electron multiplier. Results are displayed as spectra of the relative abundance of detected ions as a function of the mass-to-charge ratio. The atoms or molecules in the sample can be identified by correlating known masses (e.g. an entire molecule) to the identified masses or through a characteristic fragmentation pattern.]
 ...
 level on her kitchen telemetry^[Automated data collection and transmission to a central server for monitoring.]. And remember to wear your earrings at
 ...
 rights stitch-up^[Act of placing someone in a position in which they will be wrongly blamed for something, or of manipulating a situation to one's advantage. Presumably referring to copyright extortion.] fell apart, and the artists all went on-line while
 ...
 * * *
 ...
 Carlo free-for-all^[The Monte Carlo method encompasses any technique of statistical sampling employed to approximate solutions to quantitative problems. Essentially, the Monte Carlo method solves a problem by directly simulating the underlying (physical) process and then calculating the (average) result of the process. This very general approach is valid in areas such as physics, chemistry, computer science etc. Monte Carlo methods are often used in finance and mathematical finance to value and analyze (complex) instruments, portfolios and investments by simulating the various sources of uncertainty affecting their value, and then determining the distribution of their value over the range of resultant outcomes.] of market economics, solving the calculation
 problem^[The economic calculation problem is a criticism of using economic planning as a substitute for market-based allocation of the factors of production, first proposed by Ludwig von Mises and later expanded upon by Friedrich Hayek. Mises and Hayek argued that economic calculation is only possible by information provided through market prices, and that bureaucratic or technocratic methods of allocation lack methods to rationally allocate resources, and that the pricing systems in socialist economies were necessarily deficient because if a public entity owned all the means of production, no rational prices could be obtained for capital goods as they were merely internal transfers of goods and not "objects of exchange", unlike final goods. Therefore, they were unpriced and hence the system would be necessarily irrational, as the central planners would not know how to allocate the available resources efficiently.]. Just because he can, because hacking economics is fun, and he
 wants to hear the screams from the Chicago School^[Chicago School is a neoclassical economic school of thought that originated at the University of Chicago in the 1940s. The main tenets of the Chicago School are that free markets best allocate resources in a market economy and that minimal or even no government intervention is best. The Chicago School rejected Keynesianism in favor of monetarism, contending that the money supply should be kept in equilibrium with the demand for money.].
 ...
 * * *
 ...
 piece of Tom of Finland beefcake^[Tom of Finland was a Finnish artist known for his stylized highly masculinized homoerotic fetish art, influential on late twentieth century gay culture.], complete with breechclout and peaked
 ...
 of the 1920s. Gianni is a visionary of the left, a strange attractor^[In the mathematical field of dynamical systems, an attractor is a set of numerical values toward which a system tends to evolve, for a wide variety of starting conditions of the system.<br><br>
 An attractor is called strange if it has a fractal structure. This is often the case when the dynamics on it are chaotic. If a strange attractor is chaotic, exhibiting sensitive dependence on initial conditions, then any two arbitrarily close alternative initial points on the attractor, after any of various numbers of iterations, will lead to points that are arbitrarily far apart (subject to the confines of the attractor), and after any of various other numbers of iterations will lead to points that are arbitrarily close together. Thus a dynamic system with a chaotic attractor is locally unstable yet globally stable: once some sequences have entered the attractor, nearby points diverge from one another but never depart from the attractor.]
 ...
 disquieting glimpse into the world of the terminally future-shocked^[Too much change in too short a period of time resulting in a sense of social disconnection, shattering stress and overall disorientation].
 ...
 player," Gianni says dismissively. "He used to design Babbage engines^[Charles Babbage (1791-1871), computer pioneer, designed two classes of engine, Difference Engines, and Analytical Engines. Difference engines were based on the method of finite differences, an could not perform general arithmetical calculation, however Babbage's later Analytical Engine was a general-purpose programmable computing engine. 
<br><br>
  The Analytical Engine had a 'Store' where numbers and intermediate results could be held, and a separate 'Mill' where the arithmetic processing was performed. It had an internal repertoire of the four arithmetical functions and could perform direct multiplication and division. It was programmable using punched cards, an idea borrowed from the Jacquard loom used for weaving complex patterns in textiles. It was capable of functions for which we have modern names: conditional branching, looping (iteration), microprogramming, parallel processing, iteration, latching, polling, and pulse-shaping, amongst others.]
 for the Pentagon - stealth computers. (No van Eck radiation^[Van Eck phreaking is a form of eavesdropping in which special equipment is used to pick up side-band electromagnetic emissions from electronics devices, dubbed van Eck radiation, that correlate to hidden signals or data for the purpose of recreating these signals or data in order to spy on the electronic device. Side-band electromagnetic radiation emissions are present in and, with the proper equipment, can be captured from keyboards, computer displays, printers, and other electronic devices. <br/><br/> The name is derived from Wim van Eck, who published the first unclassified technical analysis of the security risks of emanations from computer monitors in 1985. The paper caused some consternation in the security community, which had previously believed that such monitoring was a highly sophisticated attack available only to governments; van Eck successfully eavesdropped on a real system, at a range of hundreds of metres, using just $15 worth of equipment plus a television set.  An analogue Babbage engine would give off no van Eck radiation, making it invulnerable to this attack.
], you
 ...
 automata^[Computation model of an abstract machine that can be in exactly one of a finite number of states at any given time. In this case, it is referring to the static text of the book, in contrast to dynamic digital information - presumably OCR'd (optical character recognition) by Aineko in some way.] into Manfred's left eye. The hardback is dusty and dry
...
<br/><br/>
[(Deleuze, Thousand Plateaus)](https://web.archive.org/web/20070206211421/http://www.christianhubert.com/hypertext/diagram___abstract.html)
<br/><br/>
Presumably Gianni is using abstract machine with the latter definition and Manfred understands it as the former.], as dictators have throughout history."
 ...
 * * *
 ...
 understand this distributed denial of service stuff^[A denial-of-service attack (DoS attack) is a cyber-attack in which the perpetrator seeks to make a machine or network resource unavailable to its intended users by temporarily or indefinitely disrupting services of a host connected to the Internet. Denial of service is typically accomplished by flooding the targeted machine or resource with superfluous requests in an attempt to overload systems and prevent legitimate requests from being fulfilled. <br/><br/>
In a distributed denial-of-service attack (DDoS attack), the incoming traffic flooding the victim originates from many different sources. This effectively makes it impossible to stop the attack simply by blocking a single source. <br/><br/>
In this sense, spamming companies with many superfluous lawsuits from manifold sources could be described as a legal DDoS.], but Lisa grew up
 ...
 * * *
 ...
 the significance of a chi-square test^[The chi-squared test is used to determine whether there is a significant difference between the expected frequencies and the observed frequencies. <br/><br/>
 Its "signifance" in this case might be in reference to its use in cryptoanalysis in comparing distributions of unencrypted and decrypted information to determine success of decryption, or its use in bioinformatics to compare the distribution of certain property of genes (e.g., genomic content, mutation rate, interaction network clustering, etc.) belonging different categories (e.g., disease genes, essential genes, genes on a certain chromosome etc.)], and the future still looks
 ...
 marketroid^[Slang in the IT industry for someone in a tech company's marketing department who is either not savvy on technology, or who lies or mixes up aspects of product proposals. It is said that the marketroid concentrates solely on marketing, to the exclusion of actual product technology and engineering details.
].
 ...
 posthuman genius loci of the net^[In classical Roman religion, a genius loci was the protective spirit of a certain location.], an agalmic entrepreneur turned
 ...
 * * *
 ...
 talk to the Franklin Collective^[Likely a reference to the Frankurt School, a school of marxist social theory and critical philosophy that was highly influential on the 20th century progressive left and central subject to right-wing conspiracy theory.], face-to-face, one to many ..."

 The office translator is good, but it can't provide real-time
 ...
 * * *
 ...
 went to join the omega point^[The Omega Point Theory is a spiritual belief and a scientific speculation that everything in the universe is fated to spiral towards a final point of divine unification. The term was coined by the French Jesuit Catholic priest Pierre Teilhard de Chardin. It has been argued there is significant overlap of ideas between the secular singularity and Teilhard's religious Omega Point. Ray Kurzweil, one of the most prominent singularitarians, who stated that "evolution moves inexorably toward our conception of God, albeit never reaching this ideal." Like Kurzweil, Teilhard predicts a period of rapid technological change that results in a merger of humanity and technology. This would mars the birth of the noosphere and the emergence of the "spirit of the Earth", leading to a Teilhardian Singularity.], right?"
 ...
 Astrophysicist^[Frank J. Tipler is a present-day mathematical physicist and cosmologist, and major contemporary proponent of the Omega Point Theory.], the man who would be Macx finds himself wondering if
 ...
 * * *
   ...
   American Midwest, leaving havoc and riots in its wake: Senescence^[Biological aging.]
   ...
   treatments for old age - telomere reconstruction^[Telomeres are the compound nucleotide structures at the end of a chromosome. Over time, due to each cell division, the telomere ends become shorter - this is believed to be a aspect of biological aging. Thereotically, extending or even reproducing telomeres could achieve life extensibility.] and
   ...
   that hook right into the Chomsky organ^[Noam Chomsky proposes that we can think of language as one of the ‘mental organs’ which, in coordination with other mental organs, carries out cognitive processes:<br><br>
   "In my opinion, the little that we know about these questions suggests that the mind, like the body, is in effect a system of organs - we could call them ‘mental organs’ by analogy - that is to say, highly specific systems organized according to a genetic program that determines their function, their structure, the process of their development, in quite a detailed manner. The particular realization of these fundamental principles naturally depends on their interaction with the environment. If that is correct, the mind is a complex system of interacting faculties - it is constituted of ‘mental organs’ just as specialized and differentiated as those of the body".] and talk to their owners
   through their own speech centers, and widespread public paranoia
   about limbic spam^[The limbic system is the set of brain structures that generates feelings, emotions and motivations as well as the formation of memory. Presumably limbic spam would be unwanted signals which delivers a stimulus directly to this area for advertising purposes.]. Nanotechnology has shattered into a dozen
   disjoint disciplines, and skeptics are predicting that it will all
   peter out before long. Philosophers have ceded qualia to engineers^[Qualia refers to the individual instances of subjective, conscious experience. 
Examples of qualia include the perceived sensation of pain of a headache, the taste of wine, as well as the redness of an evening sky. As qualitative characters of sensation, qualia stand in contrast to 'propositional attitudes', where the focus is on beliefs about experience rather than what it is directly like to be experiencing.<br><br>While predominately studied from a philosophical or psychological perspective, qualia has received increasing interest from a scientific perpsective. One prominent example is Roger Orpwood, an engineer with a strong background in studying neural mechanisms. Orpwood proposed a neurobiological model that gives rise to qualia and ultimately, consciousness. As advancements in cognitive and computational neuroscience continue to grow, the need to study the mind, and qualia, from a scientific perspective follows. Orpwood does not deny the existence of qualia, nor does he intend to debate its physical or non-physical existence. Rather, he suggests that qualia are created through the neurobiological mechanism of re-entrant feedback in cortical systems.],
   and the current difficult problem in AI is getting software to
   experience embarrassment.

   Fusion power is still, of course, fifty years away.^[Theoretical form of power generation in which energy will be generated by using nuclear fusion reactions to produce heat for electricity generation. In a fusion process, two lighter atomic nuclei combine to form a heavier nucleus, and at the same time, they release energy. This is the same process that powers stars like our Sun.<br><br>
   Despite serious attempts to build an efficient fusion reactor since the 1940s, to date, no design has produced more fusion power output than the electrical power input; therefore, all existing designs have had a negative power balance.]
 ...
 * * *
 ...
 What she's wearing indoors is skin-tight, iridescent and,
 disturbingly, she claims is a distributed extension of her
 neuroectoderm^[The portion of the ectoderm of the early human embryo which gives rise to the central and peripheral nervous systems.]. Stripped of costume-drama accoutrements, she's a
 ...
 call somebody?" he asks: "I want to check my back-ups."
 ...
 An elephantine semantic network^[Knowledge base that represents semantic relations between concepts in a network, often used as a form of knowledge representation. Semantic networks, also known as frame networks, are either directed or undirected graphs consisting of vertices, which represent concepts, and edges, which represent semantic relations between concepts, mapping semantic fields.] sits down on his spectacles as soon as
 ...
 identity and a quantum key exchange^[Quantum key distribution (QKD) is a secure communication method which implements a cryptographic protocol involving components of quantum mechanics. It enables two parties to produce a shared random secret key known only to them, which can then be used to encrypt and decrypt messages.<br><Br>An important and unique property of quantum key distribution is the ability of the two communicating users to detect the presence of any third party trying to gain knowledge of the key. This results from a fundamental aspect of quantum mechanics: the process of measuring a quantum system in general disturbs the system. A third party trying to eavesdrop on the key must in some way measure it, thus introducing detectable anomalies. By using quantum superpositions or quantum entanglement and transmitting information in quantum states, a communication system can be implemented that detects eavesdropping. If the level of eavesdropping is below a certain threshold, a key can be produced that is guaranteed to be secure (i.e. the eavesdropper has no information about it), otherwise no secure key is possible and communication is aborted.<br><br>The security of encryption that uses quantum key distribution relies on the foundations of quantum mechanics, in contrast to traditional public key cryptography, which relies on the computational difficulty of certain mathematical functions, and cannot provide any mathematical proof as to the actual complexity of reversing the one-way functions used. QKD has provable security based on information theory, and forward secrecy.
]. But he has his wits about him
 ...
 * * *
 ...
 speculum^[Reference to reports of alien abductions commonly including anal inspections (speculum refers to any medical device designed to inspect bodily orifices) and their most common description as 'little gray men'.]: Whole future depends on it. Manny started this with
 ...
 * * *
 ...
 guarana^[Amazonian climbing plant whose seeds contain twice the amount of caffeine of coffee beans, commonly used in energy drinks.] was a good idea," he says in tones of deep foreboding.
 ...
 * * *
 ...
 To make matters worse, pointy-haired management^[Reference to the Pointy-Haired Boss of Scott Adam's Dilbert comic.] at Arianespace" - he
 ...
 in the headboard. "Bloody aerogel^[Aerogel is a synthetic porous ultralight material derived replacing the liquid component of a gel with a gas. The result is a solid with extremely low density and low thermal conductivity that feels like fragile expanded polystyrene to the touch. Nicknames include frozen smoke, solid smoke, solid air, solid cloud, blue smoke owing to its translucent nature and the way light scatters in the material.]. Um, where was I?" He sits up.

 "Sapient network packet?" asks Alan.

 "Nope." Manfred shakes his head, grins. "Should have known you'd read
 Vinge^[Vernor Steffen Vinge. American science fiction author, originator of the technological singularity concept and perhaps the first to present a fictional 'cyberspace'.] ... or was it the movie? No, what I think is that there's only
 ...
 * * *
 ...
 "Come in." A solenoid^[Helical coil, here used as a buzzer.] buzzes; he pushes the door open, and it closes
 ...
 * * *
 ...
 help the blind see and the autistic talk, intrathecal implants^[Administration via an injection into the spinal canal or the subarachnoid space, so that the material reaches the cerebrospinal fluid, currently used for spinal anaesthesia, chemotherapy, or pain management applications.] have
...
"That the concept of the Sublime, a major aesthetic criterion of the Romantic era, has a close connection with the pleasures derived from reading sf has long been recognized by readers and critics, even if that word has seldom been used. The phrase that has been used, and which to a large extent corresponds, is ‘Sense of Wonder’ (sometimes jocularly or cynically abbreviated to ‘sensawunda’)"]. "That
 ...
 old^[5.07 years. Since measuring time in units like days, months, and years are of limited usefulness in regions not on the planet Earth, futurists suggest the usage of time measures based on the second, such as megaseconds or gigaseconds. 1 million seconds, or a megasecond, is 11.6 days; one Earth month is 2.6 megaseconds.]. If Pamela would let me message her I could find out ..." There
...
Chapter 4: Halo
 ...
 together on the signal, trains them to track its Doppler shift^[The change in frequency or wavelength of a wave in relation to an observer who is moving relative to the wave source, also known as the Doppler effect. A common example of Doppler shift is the change of pitch heard when a vehicle sounding a horn approaches and recedes from an observer. Compared to the emitted frequency, the received frequency is higher during the approach, identical at the instant of passing by, and lower during the recession.], and
 ...
 * * *
   ...
   parietal cortex^[Region of the brain dominating planned movements, spatial reasoning, and attention.] hacked for extra short-term memory, or an anterior
   superior temporal gyrus^[Region of the brain that contains the auditory cortex, which is responsible for processing sounds and the Wernicke's area, which is the major area involved in the comprehension of language. The superior temporal gyrus is involved in auditory processing, including language, but also has been implicated as a critical structure in social cognition.] tweaked for superior verbal insight, but
   ...
   quantum-entangled communication channels^[Quantum entangelement (QE) is a phenomenon in quantum mechanics where the states of two particles are locked together, even across a distance. Entangled states lead to correlations in the results of otherwise random measurements, even when the measurements are made nearly simultaneously and at far distant points. It's theorized that QE could be employed to achieve faster-than-light communication.] - her own personal
   ...
   serializable^[Serialization is the process of converting an object into a stream of bytes to store the object or transmit it to memory, a database, or a file. Its main purpose is to save the state of an object in order to be able to recreate it when needed.
<br><br>
  This is presumably used to refer to programming languages, opposed to 'human' languages, though technically human languages are also reducible to bytes; it may be a reference to object serialization which many object-oriented programming languages support (C, Java, Lisp, etc.)]; when she was seven, her mother took her to the school
 ...
 * * *
 ...
 horizon of Jupiter. Sanger is nearing perijove^[The point in the orbit of a satellite of Jupiter nearest the planet's center.], deep within the gas
 giant's lethal magnetic field^[The magnetosphere of Jupiter is the cavity created in the solar wind by the planet's magnetic field. Extending up to seven million kilometers in the Sun's direction and almost to the orbit of Saturn in the opposite direction, Jupiter's magnetosphere is the largest and most powerful of any planetary magnetosphere in the Solar System, and by volume the largest known continuous structure in the Solar System after the heliosphere. Wider and flatter than the Earth's magnetosphere, Jupiter's is stronger by an order of magnitude, while its magnetic moment is roughly 18,000 times larger.
<br><br>
The action of the magnetosphere traps and accelerates particles, producing intense belts of radiation similar to Earth's Van Allen belts, but thousands of times stronger. Radiation belts present a significant hazard for spacecraft and potentially to human space travellers.]; static discharges flicker along the
 tube, arcing over near the deep violet exhaust cloud emerging from the
 magnetic mirrors of the ship's VASIMR motor^[Variable Specific Impulse Magnetoplasma Rocket (VASIMR). The VASIMR uses radio waves to ionize and heat a propellant. Then a magnetic field accelerates the resulting plasma to generate thrust, as a plasma propulsion engine. It is intended to bridge the gap between high-thrust, low-specific impulse and low-thrust, high-specific impulse systems, and is capable of functioning in either mode. Former NASA astronaut Franklin Chang Díaz created the VASIMR concept and has been developing it since 1977.]. The plasma rocket is
 ...
 a couple of wildcat mining prospectors^[Wildcat drilling, also known as exploratory drilling, is the process of drilling for natural resources in unproven or fully exploited areas that either have no concrete historic production records or have been fully exploited as a site for oil and gas output.] and a M-commerce bus that
 ...
 can pick up a whole body radiation dose of ten Grays^[The gray (Gy) is a derived unit of ionizing radiation dose, defined as the absorption of one joule of radiation energy per kilogram of matter. The estimated median lethal dose for adult humans is 3 Gy's.] in half an hour
 ...
 pasted a caricature of her own avatar into the virch^[Colloquialism for "virtual reality".] fight. She's
 ...
 * * *
 ...
 Shenzhou-B capsule^[Shenzhou (神舟) is a spacecraft developed and operated by China using Soyuz technology to support its manned spaceflight program. The name is variously translated as divine vessel, divine craft, or divine ship. Its design resembles the Russian Soyuz spacecraft, but it is larger in size. The first launch was on November 19, 1999 and the first manned launch was on October 15, 2003.], with a Chinese type 921 space-station module^[A large basic permanent space station is planned for the third and last phase of China's millenial space program, Project 921. This will be a modular design with an eventual weight of around 60 tons, to be completed sometime before 2020.]
 ...
 M2P2 pod^[Mini-magnetospheric plasma propulsion (M2P2). A magnetic sail or magsail is a proposed method of spacecraft propulsion which would use a static magnetic field to deflect charged particles radiated by the Sun as a plasma wind, and thus impart momentum to accelerate the spacecraft. The M2P2 approach attempts to inflate the magnetic field using a plasma in the same way that the plasma around the Earth stretches out the Earth's magnetic field in the magnetosphere in in order to reduce the size and weight of the magnet of the magnetic sail. This is expected to be especially useful far from the Sun, where the increased effective size of a M2P2 sail compensates for the reduced dynamic pressure of the solar wind.] strapped to its nose. The M2P2 pod is a plasma sail, built in
 ...
 * * *
 ...
 "Aww, that's no fun. And you want to tune whatever bit-bucket^[The universal data sink. Discarded, lost, or destroyed data is said to have gone to the bit bucket. On Unix, often used for /dev/null. Sometimes amplified as the Great Bit Bucket in the Sky.] you've
 ...
 * * *
 ...
 for - or even that they're full of S-expressions^[Symbolic expressions, also known as sexprs or sexps, are a notation for nested list (tree-structured) data, invented for and popularized by the programming language Lisp, which uses them for source code as well as data.] and semidigestible
 ...
 condensates^[State of matter of a dilute gas of bosons cooled to temperatures very close to absolute zero (-273.15 °C). Under such conditions, a large fraction of bosons occupy the lowest quantum state, at which point microscopic quantum phenomena become apparent macroscopically - particularly wavefunction interference.] hovering on the edge of absolute zero. By superimposing
 ...
 of his noumen^[Thing-in-itself.] preserved and the estate trustees are trying to
 ...
 refineries^[Much speculation has been made over the possibility of helium-3 as a future energy source. Unlike most other nuclear fusion reactions, the fusion of helium-3 atoms releases large amounts of energy without causing the surrounding material to become radioactive. However, the temperatures required to achieve helium-3 fusion reactions are much higher than in traditional fusion reactions, and the process may unavoidably create other reactions that themselves would cause the surrounding material to become radioactive.
<br><br>
The abundance of helium-3 is thought to be greater on the Moon than on Earth, having been embedded in the upper layer of regolith by the solar wind over billions of years, though still lower in abundance than in the solar system's gas giants.]. It's that CETI scam I told you about earlier, but they've
 ...
 box^[Laboratory apparatus used to study animal behavior. The operant conditioning chamber] designed to train her to be normal. "Is Jupiter fun?" she asks. "I
 ...
 * * *
 ...
 with fullerenes^[Allotrope of carbon in the form of a hollow sphere, ellipsoid, tube, and many other shapes and sizes. Spherical fullerenes, also referred to as Buckminsterfullerenes or buckyballs, resemble the balls used in association football. The name is an homage to Buckminster Fuller, whose geodesic domes it resembles.]."
 ...
 superconducting wires^[Superconductivity is a quantum mechanical phenomenon of exactly zero electrical resistance and expulsion of magnetic flux fields occurring in certain materials, called superconductors, when cooled below a characteristic critical temperature. Metallic conductors see the electrical resistance decreases gradually as temperature is lowered, but in ordinary conductors, such as copper or silver, this decrease is limited by impurities and other defects. In a superconductor, the resistance drops abruptly to zero when the material is cooled below its critical temperature. With zero resistance, an electric current through a loop of superconducting wire can persist indefinitely with no power source.] along Barney's long axis. It's only a kilometer
 ...
 at about two grams per second. Using designs copylefted^[Opposite of copyright. Makes a work free to distribute and modify with the same rights preserved in derivative works.] by the free
 hardware foundation^[Reference to the Free Software Foundation, which promotes "the universal freedom to study, distribute, create, and modify computer software."], inside two hundred thousand seconds they'll have
 ...
 dome tent^[Geodesic domes are a hemispherical lattice-shell structure based on a geodesic polyhedron, championed by futurist Buckminster Fuller. The omnitriangulated surface provides an inherently stable structure by distributing the structural stress throughout the structure, making geodesic domes extremely strong for their size and weight.] and some free nitrogen/oxygen for her to breathe, then
 ...
 liner. He's floating between a TORU manual docking controller^[Teleoperated Mode of (spacecraft) Control (rus. Телеоператорный Режим Управления; TORU) system is the manual docking system of Russian Soyuz and Progress spacecraft that serves as a backup to the automatic Kurs system.] and a
 ...
 * * *
   ...
   machinery^[It is theorized atomic condensates can be used as holographic recording media, relying on the observation that the shape of a condensate in the Thomas-Fermi limit closely follows the form of the confining potential. Holographic information can thus be stored as density modulations. The recorded object can then be reconstructed with an atomic reading beam.) Electricity surges through the cable loops as they
   ...
   scooping up raw material to feed to the fractionating oven^[Used in distillation of liquid mixtures to separate the mixture into its component parts, or fractions, based on the differences in volatilities.]. Amber's
   ...
   industrial metastructures^[Structure that has properties similar to metamaterials -  obtaining its electromagnetic properties from its structure rather than from its chemical composition. Metamaterials are most often engineered by arrangement in repeating patterns at scales smaller than the wavelengths of the electroagnetic phenomena they influence.] necessary to support mining helium-three
 ...
 * * *
 ...
 "Of course I -" She stops. Alone in this Energiya NPO^ [Russian manufacturer of ballistic missile, spacecraft and space station components; prime developer and contractor of the Russian manned spaceflight program.] surplus iron
 ...
 * * *
 ...
 being a piece of state jewelry, it is also an optical router^[Delivers information at the speed of light.], part of
 ...
 boardroom bandits, from the greenmail^[The practice of buying enough shares in a company to threaten a hostile takeover so that the target will repurchase its shares at a premium.] experts with their roots in the
 ...
 Sadeq licks his suddenly dry lips. "You're going to narrowcast^[Transmit information to a comparatively small audience defined by special interest or geographical location.] a
 reply?"
...
Chapter 5: Router
 ...
 "That's a big gap. What's the cultural delta^[The rate of change imposed upon culture/society by the speed and depth of new technology. For a small population semi-isolated from the main body of society, it is a reflection that no matter how hip and intelligent any given group could be, it is impossible for a 'small town' to be as creative as a 'large city'] up to now?" Pierre asks
 ...
 * * *
 ...
 easier to think of the cat as a zimboe^[ibid.] - a zombie with no
 ...
 "That's right," says the cat. "I was supposed to fork repeatedly^[Fork bomb is a denial-of-service attack wherein a process continually replicates itself to deplete available system resources, slowing down or crashing the system due to resource starvation.] and
 ...
 * * *
   ...
   - just short of three light-years - behind the speeding starwhisp^[Class of human-built space exploration probes; the name is intended to suggest the relative size (small) and mass (low—generally of the order of grams, or at most, a few kilograms) when compared to such fictional behemoths as the USS Enterprise.]
   ...
   that out-think their meaty cortices by many orders of magnitude -
   ...
   a major economic catastrophe. Cheap immortagens^[Age extensions.], out-of-control
   personality adjuvants^[A pharmacological or immunological agent that modifies the effect of other agents.], and a new formal theory of uncertainty have
   ...
   subsequent spate of network raids and Basilisk attacks^[A basilisk is a visual representation which causes harm (usually death) by triggering a thought which the human brain is physically or logically incapable of thinking.] cause havoc.
 ...
 * * *
 ...
 environmental protests over de-orbiting a small Jovian moon is a
 ...
 barratry^[Offense committed by people who are overly officious in instigating or encouraging prosecution of groundless litigation or who bring repeated or persistent acts of litigation for the purposes of profit or harassment.], trial by combat, and compurgation^[Defence used primarily in medieval law where a defendant could establish his innocence or nonliability by taking an oath and by getting a required number of persons, typically twelve, to swear they believed the defendant's oath. Also known as wager of law and oath-helping.]." He pulls a face and
 ...
 * * *
 ...
 'optimized conscious upload that runs much faster than real-time'. A
 ...
 * * *
 ...
 hurry. "We don't know enough about post-singularity civilizations."
 ...
 * * *
 ...
 Where's the exotic superscience? What about the neuron stars^[ibid.], strange
 ...
 * * *
 ...
 them. "I don't trust him out in the unrestricted sim-spaces yet, but
 ...
 * * *
 ...
 updates on what's going on down-well? We're only twenty objective days
 ...
 given the ship's multi-avabit^[ibid.] storage capacity - one avabit is
 ...
 * * *
 ...
 The orang-utan finds the nearest cable and gives it a yank, setting
 ...
 * * *
 ...
 they'd just set up a wake shield^p[] in orbit, chill it down to a
 fractional Kelvin, whack two coherent matter^p[] beams together, teleport
 ...
 * * *
 ...
 Snapshots from the family album: While you were gone ...
   ...
   * Collapse of the trans-Lunar economy: Deep in the hot thinking
     ...
     hamper them, and no need to spawn and reap start-ups Darwin-style,
   ...
   * Surprise and postcards from the inner orbitals - Amber's mother
     ...
     absent-minded and prone to lose himself in the intertextual
 ...
 * * *
 ...
 a spider-silk cable a kilometer beneath the space-frame underpinnings
 of the city.
 ...
 for his pitch. "At the lowest level, you can store back-ups of
 ...
 than real-time in archive space until we find a new world to settle."
 ...
 spark of a de-orbiting spacecraft.
 ...
 * * *
 ...
 brought back a real-live alien?"
 ...
 * * *
 ...
 Offspring seem to feel it's necessary to apply valuable exaquops^[Quintillions of quantum-computation operations.] to
 ...
 * * *
 ...
 applied theological engineering [see: God bothering^[Persisently promoting religious beliefs to others, even when unwelcome.]].
 ...
 * * *
   ...
   Only Annette isn't being very helpful right now. His mother is
 ...
 * * *
 ...
 burgeoning Matrioshka brain.) Due to a resource contention problem^[Conflict over access to a shared resource such as random access memory, disk storage, cache memory, internal buses or external network devices.] in
 ...
 He blinks, barely noticing her black bob of hair, chromatophore^[Pigment-containing and light-reflecting cells, or groups of cells, found in a wide range of animals including amphibians, fish, reptiles, crustaceans and cephalopods.]-tinted
 ...
 walls are braced with turquoise-painted girders, and the perspex^[Solid transparent plastic made of polymethyl methacrylate (the same material as Plexiglas or Lucite).]
 ...
 partials re-integrate, dumping a slew of positively pornographic
 ...
 * * *
 ...
 ones who ran his pre-adolescent brain through a couple of dozen
 ...
 * * *
 ...
 But that doesn't mean we can't leave back-ups behind."
 ...
 * * *
   ...
   project is mind-boggling: notwithstanding that canned apes are
 ...
 * * *
   ...
   spinning habitats strung in orbit around cold brown dwarf stars and
 ...
 * * *
 ...
 you understand that? I need to instantiate a real-live adult Manfred
 ...
 * * *
 ...
 Understand? Say yes, Manfred; if you leave your mouth open like that,
